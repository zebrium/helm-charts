# Raw
The `raw` chart takes a list of Kubernetes resources and
merges each resource with a default `metadata.labels` map and installs
the result.  This is a port from the deprecated chart [incubator/raw](https://github.com/helm/charts/blob/master/incubator/raw/README.md) 
